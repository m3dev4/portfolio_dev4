...
const projects = [
  {
    ...
    images: ["/images/kortext-illust-1.png", "/images/kortext-illust-2.png"],
  },
  {
    title: "Meethub",
    description:
    ...
    images: ["/images/meethub-illust-1.png", "/images/meethub-illust-2.png"],
  },
  {
    title: "Syntek",
    description:
      "Syntek est un outil de création et de retouche d'images conçu pour faciliter les tâches de traitement visuel complexes, le tout dans une interface simple et intuitive. Inspirée de Canva, elle permet aux utilisateurs de transformer leurs images avec plusieurs fonctionnalités puissantes. Syntek s'adresse à tous, des créateurs de contenu aux professionnels du design, cherchant un outil polyvalent pour perfectionner leurs visuels en quelques clics.",
    lien: "https://syntek.vercel.app/",
    images: ["/images/syntek-illust-1.png", "/images/syntek-illust-2.png"],
  },
  {
    title: "SmartCV",
    description:
      "Un générateur de CV moderne, simple, efficace et open-source qui simplifie le processus de création, de mise à jour et de partage de votre CV.",
    lien: "https://smartcv-74h9.onrender.com/",
    images: [
      "/images/smartcv_illust_1.png",
      "/images/smartcv_illust_2.png",
      "/images/smartcv_illust_3.png",
    ],
  },
  {
    title: "Conteo",
    ...
    images: ["/images/conteo-illust-1.png", "/images/conteo-illust-2.png"],
  },
  {
    title: "Apple landing",
    description:
  ...
  },
  {
    title: "Najma Jamila",
    description:
      "Découvrez Najma Jamila, votre marque de cosmétiques naturels au Sénégal. Soins pour la peau, sérums Bioaqua et routines beauté adaptées à vos besoins : anti-acné, anti-taches et hydratation.",
    lien: "",
    video: "/video/najma.mp4",
  },
];
