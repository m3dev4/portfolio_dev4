...
export const BentoGridItem = ({
    ...
    return (
        ...
        >
                ...
                {id === 3 && (
                    <div>
                        <Image
                            ...
                            width={4044}
                            height={2267}
                            className="w-full h-full object-cover absolute left-0 bg-opacity-15"
                        />
                    </div>
                )}
                {id === 4 && (
            ...
            <div className=
                     "group-hover/bento:translate-x-2 transition duration-200 relative md:h-full px-5 p-5 lg:p-10  flex flex-col"
            >
                <div className={cn(`"font-sans text-lg lg:text-3xl max-w-96 font-bold text-white z-10" 
                ${id === 5 ? "flex justify-center items-center -mt-96 relative " : ""}
                ${id === 2 ? "-mt-28" : ""}`)}>
                    {title}
                </div>
